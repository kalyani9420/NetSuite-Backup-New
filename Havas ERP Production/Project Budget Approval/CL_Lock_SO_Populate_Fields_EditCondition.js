 ...
 */ function (currentRecord, search) {
  function pageInit(scriptContext) {
    try {
      ...
      var natureOfDocument = soRecordObj.getField({
  ...
  function validateLine(scriptContext) {
    try {
      ...
      var soProjectStatus = soRecordObj.getValue({
    ...
    try {
      ...
      if (_logValidation(soProject)) {
        ...
        if (
          ...
          if (soRecordId != "" && soProjectStatus == "") {
            if (_logValidation(soProject)) {
              var getSales = getPurchaseSales(
                soProject,
                "SalesOrd",
                soRecordId
              );
              var getProjectBillingBudget = getProjectBudget(
                soProject,
                "BILLING"
              );
