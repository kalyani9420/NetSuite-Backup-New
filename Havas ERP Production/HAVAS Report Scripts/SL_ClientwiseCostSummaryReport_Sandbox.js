...
define(["N/ui/serverWidget", "N/search"], (serverWidget, search) => {
    ...
    let getDebit = (fromDate, uptoDate, selectedLocations, selectedDepartment) => {
        ...
        let filters = [[["type", "anyof", "CustCred", "VendPymt", "Custom113", "VendBill", "VPrep", "ExpRept", "Check"], "AND", ["mainline", "any", ""], "AND", ["trandate", "within", fromDate, uptoDate], "AND", ["posting", "is", "T"],],
    ...
    let getLocationOpeningBalance = (fromDate, selectedLocations) => {
        ...
        let filters = [["type", "anyof", "CustDep", "VendCred", "VendPymt", "CustInvc", "VendBill", "CustCred", "VPrep", "ExpRept", "CustPymt", "Custom113", "Journal"], "AND", ["mainline", "any", ""], "AND", ["posting", "is", "T"], "AND", ["trandate", "onorbefore", fromDate], "AND", ["job.entityid", "isnotempty", ""]];
