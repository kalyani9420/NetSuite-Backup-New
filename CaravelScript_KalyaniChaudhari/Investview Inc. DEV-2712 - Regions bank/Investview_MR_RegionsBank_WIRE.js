...
define(["N/currentRecord", "N/search", "N/file", "N/format", "N/runtime" , "N/record"], (
  ...
  const map = (mapContext) => {
    ...
    log.debug('entityBankBIC' , entityBankBIC);
    log.debug('typeof entityBankBIC' , typeof entityBankBIC);
