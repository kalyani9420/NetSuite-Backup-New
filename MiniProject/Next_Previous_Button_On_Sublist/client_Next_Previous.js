...
define(['N/currentRecord', 'N/format', 'N/runtime'],
    ...
    function (currentRecord, format, runtime) {
        ...
        function fieldChanged(scriptContext) {
            ...
            if (scriptContext.fieldId == "custpage_from_date" || scriptContext.fieldId == "custpage_to_date") {
                ...
                if (custFrom && custTo) {
                    ...
                    var url =
                        "https://td2881259.app.netsuite.com/app/site/hosting/scriptlet.nl?script=789&deploy=1";
                    url +=
                        "&custpage_from_date=" +
                        custFrom_Format +
                        "&custpage_to_date=" +
		...
		function next() {
            ...
            var url = 'https://td2881259.app.netsuite.com/app/site/hosting/scriptlet.nl?script=789&deploy=1'
