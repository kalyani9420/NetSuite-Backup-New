            ...
            if (scriptContext.request.method === 'GET') {
				...
				if(SO_Array){
					...
					var scheduledScript = task.create({
                      ...
                      scheduledScript.scriptId = 'customscript847';
					  scheduledScript.deploymentId = 'customdeploy1';
					  scheduledScript.params = {
							'custscript6' : SO_Array,
							'custscript7': customer_name,
							'custscript8': fromDate,
							'custscript9': toDate,
							'custscript10': customerName
