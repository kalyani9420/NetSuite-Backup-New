            ...
            if (Object.prototype.hasOwnProperty.call(projectIdObject, delgCode)) {
                ...
                if (delgProject.length) {
                    ...
                    if ((!selectedProjectsArray.length || selectedProjectsArray.includes(String(id))) && isValid(id)) {
                        ...
                        projectObject[id] = { id, code: delgCode, creationDate: p.values["formuladate"], location: p.values["formulatext"], department: p.values["formulatext_1"], customer: cleanDisplayName(p.values["formulatext_2"], true) , billingBudget : p.values["formulatext_4"], costBudget : p.values["formulatext_5"]};
