...
define([], function () {
  ...
  function exportReport() {
    try {
      ...
      let csvContent = 'Creation Date,Location,Department,Customer,Project Code,SO Value,SB Value,JV Sales,CN Value,Net Sales,PO Value,PB Value,Expense Report,JV Purchase,DN Value,Net Expense,Gross Expense,Planned Margin,Actual Margin,Actual Margin %\n';
 
      for (let i = 1; i <= rowCount; i++) {
        const creationLocation   = nlapiGetLineItemValue(sublistId, 'custpage_creation_date', i);
        ...
        const row = [
          formatCSVCell(creationLocation),
