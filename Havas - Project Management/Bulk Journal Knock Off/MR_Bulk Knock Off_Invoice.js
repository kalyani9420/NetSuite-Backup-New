        ...
        function map(mapContext) {
            try {
                ...
                if (_logValidation(invoiceVoucherNo)) {
                    ...
                    let invoiceLineNumber = objRecord.findSublistLineWithValue({ sublistId: 'apply', fieldId: 'doc', value: invoiceVoucherNo }); 
                    ...
                    if (invoiceLineNumber !== -1) {
                        ...
                        log.debug('Invoice Not found in apply sublist : ', invoiceVoucherNo);
                    }
                    ...
                    if (journalLineNumberInCredit !== -1) {
                        ...
                        log.debug('Journal Not found in credit sublist : ', journalVoucherNo);
                    }
                    let receiptId = objRecord.save();
