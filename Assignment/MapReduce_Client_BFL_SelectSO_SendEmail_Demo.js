...
define(['N/currentRecord', 'N/format'],
    ...
    function (currentRecord, format) {
                ...
                if (custFrom && custTo) {
                    ...
                    custTo_Format = format.format({
                        ...
                        type: format.Type.DATE,
						 ...
						 var url =
                        "https://tstdrv2816485.app.netsuite.com/app/site/hosting/scriptlet.nl?script=849&deploy=1";
                    url +=
                        "&custpage_from_date=" +
                        custFrom_Format +
                        "&custpage_to_date=" +
        ...
        function setMemo() {
            ...
            var url = 'https://tstdrv2816485.app.netsuite.com/app/site/hosting/scriptlet.nl?script=849&deploy=1&compid=TSTDRV2816485'
