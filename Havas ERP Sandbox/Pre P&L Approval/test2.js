 ...
 */ (currentRecord, record, task, search, email, url) => {
  ...
  const onAction = (scriptContext) => {
    ...
    try {
      ...
      var projectCode = projectObj.getText({
        fieldId: "entityid",
      });
  ...
  function sendApprovalRequest(projectId, projectCode) {
    try {
      ...
      var plstatement = getPlStatemetJson(projectId);

      log.debug(" plstatement ", plstatement);
      ...
      if (cost_projectBudget != 0 || billing_projectBudget != 0) {
        ...
        // htmlTable +=
        //   "<p>" +
        //   "Please find below the project has exceeded its budget. " +
        //   "</p>";
        // htmlTable += "<p>" + "Project Id : " + projectCode + "</p>";
        // htmlTable += "<br>";
        // htmlTable += "</div>";

        // htmlTable += "<p>" + "Project Budget :  " + "</p>";
        // htmlTable +=
        //   '<table style="text-align: center; width:60% ; padding-top: 10px; font-size: 13px;">';
        // htmlTable +=
        //   '<tr style="border: 1px solid #000000; text-align: left; background-color: #607799";>';
        // htmlTable +=
        //   '<th style="border: 1px solid #000000; text-align: left; padding: 8px; width:30%; color : #ffffff">' +
        //   "Budget Type" +
        //   "</th>";
        // htmlTable +=
        //   '<th style="border: 1px solid #000000; text-align: left; padding: 8px; width:30%; color : #ffffff">' +
        ...
        // htmlTable += '<tr style="border: 1px solid #000000; text-align: left;";>';
        // htmlTable +=
        //   '<td style="border: 1px solid #000000; text-align: left; padding: 5px; width:30%;">' +
        //   "Costing" +
        //   "</td>";
        ...
        // htmlTable += "<p>" + "Profit & Loss Statement :  " + "</p>";
        ...
        // htmlTable +=
        //   '<th style="border: 1px solid #ddd; text-align: left; padding: 8px; width:30%; color : #ffffff">' +
        //   "Cost Category" +
        //   "</th>";
        // htmlTable +=
        //   '<th style="border: 1px solid #ddd; text-align: left; padding: 8px; width:30%; color : #ffffff">' +
        ...
        // htmlTable +=
        //   '<td style="border: 1px solid #ddd; text-align: left; padding: 5px; width:30%;">' +
        //   plstatement["costLabour"] +
        //   "</td>";
        // htmlTable +=
        //   '<td style="border: 1px solid #ddd; text-align: left; padding: 5px; width:30%;">' +
        //   plstatement["costExpense"] +
        //   "</td>";
        // htmlTable +=
        //   '<td style="border: 1px solid #ddd; text-align: left; padding: 5px; width:30%;">' +
        //   plstatement["costSupplier"] +
        //   "</td>";
        // htmlTable +=
        //   '<td style="border: 1px solid #ddd; text-align: left; padding: 5px; width:30%;">' +
        //   plstatement["costOther"] +
        //   "</td>";
        // htmlTable +=
        //   '<td style="border: 1px solid #ddd; text-align: left; padding: 5px; width:30%;">' +
        //   plstatement["costTotal"] +
        //   "</td>";
        ...
        // htmlTable +=
        //   '<td style="border: 1px solid #ddd; text-align: left; padding: 5px; width:30%;">' +
        //   plstatement["revenueLabour"] +
        //   "</td>";
        // htmlTable +=
        //   '<td style="border: 1px solid #ddd; text-align: left; padding: 5px; width:30%;">' +
        //   plstatement["revenueExpense"] +
        //   "</td>";
        // htmlTable +=
        //   '<td style="border: 1px solid #ddd; text-align: left; padding: 5px; width:30%;">' +
        //   plstatement["revenueSupplier"] +
        //   "</td>";
        // htmlTable +=
        //   '<td style="border: 1px solid #ddd; text-align: left; padding: 5px; width:30%;">' +
        //   plstatement["revenueOther"] +
        //   "</td>";

        // htmlTable +=
        //   '<td style="border: 1px solid #ddd; text-align: left; padding: 5px; width:30%;">' +
        //   plstatement["revenueTotal"] +
        //   "</td>";
        ...
        htmlTable += "<td style='padding: 8px;'>Costing</td>";
        htmlTable +=
          "<td style='padding: 8px;'>" + plstatement["costLabour"] + "</td>";
        htmlTable +=
          "<td style='padding: 8px;'>" + plstatement["costExpense"] + "</td>";
        htmlTable +=
          "<td style='padding: 8px;'>" + plstatement["costSupplier"] + "</td>";
        htmlTable +=
          "<td style='padding: 8px;'>" + plstatement["costOther"] + "</td>";
        htmlTable +=
          "<td style='padding: 8px;'>" + plstatement["costTotal"] + "</td>";
        htmlTable += "</tr>";

        htmlTable += "<tr style='border-bottom: 1px solid #505050;'>";
        htmlTable += "<td style='padding: 8px;'>Billing</td>";
        htmlTable +=
          "<td style='padding: 8px;'>" + plstatement["revenueLabour"] + "</td>";
        htmlTable +=
        ...
        htmlTable +=
          ...
          "</td>";
        htmlTable +=
          "<td style='padding: 8px;'>" + plstatement["revenueOther"] + "</td>";
        htmlTable +=
          "<td style='padding: 8px;'>" + plstatement["revenueTotal"] + "</td>";
        htmlTable += "</tr>";
        ...
        htmlTable += "</a>";
        htmlTable +=
          "<a style='color:#ffffff' href='" + RejectSuiteletUrl + "'>";
        htmlTable +=
  ...
  function getPlStatemetJson(projectId) {
    ...
    try {
      ...
      var costLabour = objRecord.getSublistValue({
        sublistId: "plstatement",
        fieldId: "cost",
        line: 0,
      });
      var costExpense = objRecord.getSublistValue({
        sublistId: "plstatement",
        fieldId: "cost",
        line: 1,
      });
      var costSupplier = objRecord.getSublistValue({
        sublistId: "plstatement",
        fieldId: "cost",
        line: 2,
      });
      var costOther = objRecord.getSublistValue({
        sublistId: "plstatement",
        fieldId: "cost",
        line: 3,
      });
      var costTotal = objRecord.getSublistValue({
        sublistId: "plstatement",
        fieldId: "cost",
        line: 4,
      });
      var revenueLabour = objRecord.getSublistValue({
        sublistId: "plstatement",
        fieldId: "revenue",
        line: 0,
      });
      var revenueExpense = objRecord.getSublistValue({
        sublistId: "plstatement",
        fieldId: "revenue",
        line: 1,
      });
      var revenueSupplier = objRecord.getSublistValue({
        sublistId: "plstatement",
        fieldId: "revenue",
        line: 2,
      });
      var revenueOther = objRecord.getSublistValue({
        sublistId: "plstatement",
        fieldId: "revenue",
        line: 3,
      });
      var revenueTotal = objRecord.getSublistValue({
        sublistId: "plstatement",
        fieldId: "revenue",
        line: 4,
      });
      ...
      log.debug("plJSON : ", plJSON);

      return plJSON;
    } catch (error) {
      log.debug("Error 5 : ", error);
    }
  }
